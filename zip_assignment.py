...
| code
    | <EVERYTHING HERE WILL BE INCLUDED IN THE ZIP FILE>
| graphs
    | <EVERYTHING HERE WILL BE INCLUDED IN THE ZIP FILE>
| data
...
def main():
    ...
    # Check if there exists all the .py files that we're looking for - to assert, but then we'll end up zipping everything .py
    python_files = ["stage_one.py", "stage_two.py", "stage_three.py", "utils.py"]
    ...
    zip_path = "viz-submission-1951A.zip"
    with zipfile.ZipFile(zip_path, "w") as zip:
        ...
        # Write the graphs
        for f in get_all_file_paths("graphs" + os.sep, "*"):
            zip.write(f)
